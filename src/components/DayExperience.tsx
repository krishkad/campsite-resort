...
const DayExperience = () => {
  ...
  const daySchedule = [
    {
      time: "7:00 AM",
      title: "Sunrise Yoga",
      description: "Begin your day with gentle yoga as the sun rises over the mountains, connecting body and spirit with nature's awakening.",
      icon: "🧘‍♀️",
    ...
    },
    {
      ...
      description: "Savor locally-sourced delicacies and artisanal coffee on your private deck while birds serenade the morning.",
      icon: "🥐",
    ...
    },
    {
      ...
      description: "Explore hidden trails with our naturalist guides, discovering rare wildlife and pristine wilderness landscapes.",
      icon: "🌲",
    ...
    },
    {
      ...
      description: "Kayak across crystal-clear waters or try your hand at catch-and-release fishing in our pristine alpine lake.",
      icon: "🛶",
    ...
    },
    {
      ...
      description: "Gather around the fire for a chef-prepared meal featuring local ingredients and s'mores under the evening sky.",
      icon: "🔥",
    ...
    },
    {
      time: "9:00 PM",
      title: "Stargazing",
      description: "Marvel at the Milky Way through our telescope while learning constellations from astronomy experts.",
      icon: "⭐",
      image: "https://images.unsplash.com/photo-1472396961693-142e6e269027?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
  ...
  const prevStep = () => {
    setActiveStep((prev) => (prev - 1 + daySchedule.length) % daySchedule.length);
    setIsAutoPlaying(false);
  };
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto font-light leading-relaxed">
            Every moment is carefully crafted to blend adventure with tranquility, creating memories that last a lifetime
          </p>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div className="relative">
              <div className="aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl">
                ...
                />
                <div className={`absolute inset-0 bg-gradient-to-br ${daySchedule[activeStep].color} opacity-20`}></div>
              </div>
              
              {/* Floating Time Badge */}
              <div className="absolute -top-4 -right-4 bg-white rounded-2xl px-6 py-3 shadow-xl">
                <span className="text-2xl font-light text-gray-800">{daySchedule[activeStep].time}</span>
              </div>
            </div>

            {/* Content Side */}
            <div className="space-y-6">
              <div className="text-6xl mb-4">{daySchedule[activeStep].icon}</div>
          ...
          <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-8 shadow-xl">
            <h4 className="text-2xl font-light text-gray-800 mb-6 text-center">Complete Day Timeline</h4>
