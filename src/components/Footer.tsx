      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="py-16 border-b border-white/10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 font-light">
              Receive exclusive offers, seasonal updates, and insider guides to wilderness adventures
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              ...
              />
              <Button className="bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white rounded-xl px-8 whitespace-nowrap">
                Subscribe
              </Button>
            </div>
          </div>
        ...
        <div className="py-16">
          <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-12">
            ...
            <div className="lg:col-span-2">
              <div className="mb-6">
                ...
                <p className="text-gray-300 font-light leading-relaxed max-w-md">
                  Where wilderness meets luxury. We create extraordinary experiences that reconnect you with nature&apos;s beauty while providing unparalleled comfort and service.
                </p>
              </div>
              
              {/* Social Links */}
              <div className="flex space-x-4">
                <Button variant="outline" size="icon" className="rounded-full border-white/20 text-white hover:bg-white/10 hover:border-emerald-400">
            ...
            {/* Quick Links */}
            <div>
              <h4 className="text-xl font-medium mb-6 text-emerald-400">Experience</h4>
              <ul className="space-y-3">
                {['Accommodations', 'Day Adventures', 'Gallery', 'Guest Stories', 'Booking', 'Gift Cards'].map((link) => (
                  <li key={link}>
                    <a href="#" className="text-gray-300 hover:text-emerald-400 transition-colors duration-200 font-light">
                      {link}
                    </a>
                  </li>
                ))}
            ...
            {/* Contact Info */}
            <div>
              <h4 className="text-xl font-medium mb-6 text-emerald-400">Contact</h4>
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  <MapPin className="w-5 h-5 text-emerald-400 mt-1 flex-shrink-0" />
                  <div>
                    <p className="text-gray-300 font-light">123 Pine Valley Road</p>
                    <p className="text-gray-300 font-light">Mountain View, CA 94041</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <p className="text-gray-300 font-light">hello@pinevalleyresort.com</p>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 font-light">8:00 AM - 8:00 PM Daily</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
            <div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-6 text-gray-400 text-sm">
              ...
              <div className="flex space-x-4">
                ...
                <a href="#" className="hover:text-emerald-400 transition-colors duration-200">Sustainability</a>
              </div>
            </div>
