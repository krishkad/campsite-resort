  ...
  const camps = [
    {
      ...
      amenities: ["360° Views", "King Bed", "Private Bath", "Hot Tub", "Fireplace", "AC/Heat"],
      description: "Immerse yourself in luxury with panoramic forest views through our geodesic dome's floor-to-ceiling windows.",
      available: true
    },
    {
      id: 2,
      ...
      amenities: ["2 Bedrooms", "Full Kitchen", "Private Deck", "BBQ Grill", "Fireplace", "Forest Views"],
      description: "A secluded haven where rustic charm meets contemporary luxury in perfect harmony.",
      available: true
    },
    {
      id: 3,
      ...
      amenities: ["River Views", "Queen Bed", "Shared Bathhouse", "Electricity", "Seating Area", "Fire Pit"],
      description: "Wake up to the gentle sounds of flowing water in our elegantly appointed safari-style accommodations.",
      available: false
    }
  ];
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto font-light leading-relaxed">
            From intimate glamping domes to spacious forest cottages, each accommodation offers a unique blend of luxury and nature
          </p>
        </div>
          ...
          {camps.map((camp, index) => (
            ...
            >
              ...
              <div className="relative overflow-hidden h-72">
                ...
                <div className="absolute bottom-4 left-4 text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm opacity-75">• {camp.capacity}</span>
                  </div>
                </div>
              </div>
              ...
              <CardContent className="p-8">
                <div className="mb-4">
                  <Badge variant="outline" className="mb-3 text-emerald-600 border-emerald-200">
                    {camp.type}
                  </Badge>
                  <h3 className="text-2xl font-light text-gray-800 mb-2">{camp.name}</h3>
                ...
                {/* Amenities */}
                <div className="mb-6">
                  <h4 className="text-sm font-medium text-gray-700 mb-3 tracking-wide">AMENITIES</h4>
                  <div className="flex flex-wrap gap-2">
                    {camp.amenities.map((amenity, idx) => (
                      <Badge key={idx} variant="outline" className="text-xs py-1 px-2 border-gray-200 text-gray-600">
                        {amenity}
                      </Badge>
                    ))}
                  </div>
